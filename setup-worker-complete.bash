...
echo ""
echo "2. Copy the output and run it here:"
echo "   sudo kubeadm join 10.0.0.10:6443 --token <token> --discovery-token-ca-cert-hash sha256:<hash>"
echo ""
